...
class SecondaryContactTelephoneNumberControllerSpec extends SpecBase with NunjucksSupport with JsonMatchers {
  ...
  "SecondaryContactTelephoneNumber Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val filledForm = form.bind(Map("telephoneNumber" -> "07000000000"))
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, secondaryContactTelephoneNumberRoute)
          .withFormUrlEncodedBody(("telephoneNumber", "07000000000"))

    ...
    implicit request =>
      form
        ...
        .fold(
          ...
          value => {
            val redirectUsers = redirectToSummary(value, SecondaryContactNamePage, mode, request.userAnswers)
            ...
            for {
              ...
              if (redirectUsers) {
                ...
                Redirect(navigator.nextPage(SecondaryContactNamePage, mode, updatedAnswers))
              }
          }
        )
  }

...
case class AddressLookup(lines: Seq[String], town: String, county: Option[String], postcode: String)
...
object AddressLookup {
  implicit val addressLookupReads: Reads[AddressLookup] = {
    (
      ...
      )((lines, town, county, postcode) => AddressLookup(lines, town, county, postcode))

...
class InformationSentControllerSpec extends SpecBase with NunjucksSupport with JsonMatchers {
  ...
  "InformationSent Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      val request = FakeRequest(GET, informationSentRoute)
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(InformationSentPage, "answer").success.value
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, informationSentRoute)
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val application = applicationBuilder(userAnswers = Some(emptyUserAnswers)).build()
      val request = FakeRequest(POST, informationSentRoute).withFormUrlEncodedBody(("value", ""))
